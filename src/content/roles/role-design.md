...
The lab's products are the counter-environments. The design of those environments is not aesthetic — it's functional in the deepest sense. WAXFEED is designed to surface authentic musical identity. GPS is designed to make a city legible to itself. IΔ assessments have to be designed to be credible to clinical buyers and regulators. In each case, the design IS the instrument, or it's what makes the instrument's findings legible to the people who need to act on them.

This is not a brand or marketing design role. It's a product and communication design role with direct implications for whether the lab's research question can be answered. A WAXFEED interface that optimizes for engagement over authentic taste response breaks the instrument. An IΔ report that reads like a generic AI audit doesn't land with a CMO. The design decisions have stakes.
...
**Lab-wide:** The lab's public-facing identity — how it looks across the site, in documents, in presentation materials — needs visual coherence. This sits alongside project-specific work, not above it. The lab identity serves the work, not the other way around.

---

## What Stays With Domain Leads and the Founder
...
Polarity Lab LLC is Theodore's. You are a collaborator, not an owner. You have no governance rights over the lab's direction or product decisions.

Design work you produce for the lab belongs to the lab. This includes interface designs, report templates, visual systems, and any other design assets produced in the course of your work.
...
*The design is the environment. In the lab's context, that means it's also part of the instrument. Build with that awareness.*
